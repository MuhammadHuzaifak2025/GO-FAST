                    ...
                    onPress: async () => {
                        try {
                            ...
                            const response = await axios.delete(
                                `${process.env.EXPO_PUBLIC_BACKEND_URL}/gofast/api/ride/user/passenger/${ride_id}/${passenger_id}`,
                            );
                        ...
                        try {
                            ...
                            if (action === "accept") {
                                if (myRide.seat_available < seatsRequested) {
                                    toast.show(
                                        "Not enough seats available to accept this request.",
                                        {
                                            type: "danger",
                                            duration: 4000,
                                            offset: 30,
                                ...
                                response = await axios.post(
                                    `${process.env.EXPO_PUBLIC_BACKEND_URL}/gofast/api/ride/request/accept`,
                                    { requestId: req_id },
                                );
                            } else {
                                response = await axios.delete(
                                    `${process.env.EXPO_PUBLIC_BACKEND_URL}/gofast/api/ride/request/reject/${req_id}`,
                                );
                            }
                            if (response.status === 200) {
                                if (action === "accept") {
                                    ...
                                    setMyRide({
                                        ...myRide,
                                        seats_available: myRide.seat_available - seatsRequested,
                                    });
                                }
...
const ManageRides = () => {
    ...
    const fetchRequests = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.get(
                `${process.env.EXPO_PUBLIC_BACKEND_URL}/gofast/api/ride/request/${myRide.ride_id}`,
            );
            if (response.status === 200) {
    ...
    const fetchPassengers = useCallback(async () => {
        ...
        try {
            await setAuthHeaders(axios);
            const response = await axios.get(
                `${process.env.EXPO_PUBLIC_BACKEND_URL}/gofast/api/ride/user/passenger/${myRide.ride_id}`,
            );
            if (response.status === 200) {
    ...
    useEffect(() => { }, [myRide.seats_available]);
                    ...
                    onPress: async () => {
                        try {
                            ...
                            const response = await axios.put(
                                `${process.env.EXPO_PUBLIC_BACKEND_URL}/gofast/api/ride/complete`,
                                { ride_id: myRide.ride_id },
                            );
            ...
            <View style={styles.content}>
                ...
                {loadingP ? (
                    ...
                    <FlashList
                        ...
                        ListEmptyComponent={() => (
                            <Text style={styles.emptyText}>No passengers for this ride</Text>
                        )}
                    />
                )}
